...
Arrays reuse the syntax but with intervining limits and dimensionality. For example:
...
The type (long integer or float) of a variable is set each time an element is stored into it.  (Be careful!)
